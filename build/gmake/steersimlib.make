...
ifeq ($(config),debug)
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L. -L../lib -dynamiclib -stdlib=libc++ -Wl,-rpath,/Users/russ/Desktop/A6/steersuite-rutgers/build/lib -install_name @rpath/libsteersimlib.dylib
